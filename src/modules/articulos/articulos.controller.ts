...
export class ArticulosController {
  ...
  @ApiOperation({
    summary:
      'Obtener artículos con filtros de estado, búsqueda por nombre y paginación',
  })
  @ApiQuery({
    name: 'estado',
    required: false,
    enum: Estado,
    description: 'Filtrar por DISPONIBLE o VENDIDO',
  })
  @ApiQuery({
    name: 'search',
    required: false,
    type: String,
    description: 'Buscar artículos por nombre',
  })
  @ApiQuery({
    name: 'pagina',
    required: false,
  ...
  async anularVenta(@Param('id', ParseIntPipe) id: number) {
    return this.articulosService.anularVenta(id);
  }
}
